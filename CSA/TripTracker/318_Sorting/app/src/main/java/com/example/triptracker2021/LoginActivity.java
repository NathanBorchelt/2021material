            ...
            public void onClick(View view) {
                ...
                if (email.isEmpty()) {
                    ...
                    mFirebaseAuth.signInWithEmailAndPassword(email, password).addOnCompleteListener(com.example.triptracker2021.LoginActivity.this, new OnCompleteListener<AuthResult>() {
                        ...
                        public void onComplete(@NonNull Task<AuthResult> task) {
                            if (task.isSuccessful()) {
                                Toast.makeText(com.example.triptracker2021.LoginActivity.this, "You are Logged In", Toast.LENGTH_LONG).show();
                                Log.d("Getting Loc","Login activity, before currentUser");
